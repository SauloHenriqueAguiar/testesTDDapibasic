...
describe('Testing api routes', () => {
    ...
    it('should to register with existing email', (done) => {
        request(app)
            .post('/register')
            .send(`email=${email}&password=${password}`)
            .then(response => {
    ...
    it('should to register without password', (done) => {
        request(app)
            .post('/register')
            .send(`email=${email}`)
            .then(response => {
    ...
    it('should to register without email', (done) => {
        request(app)
            .post('/register')
    ...
    it('should to register without any data', (done) => {
        request(app)
            .post('/register')
            .send(``)
            .then(response => {
